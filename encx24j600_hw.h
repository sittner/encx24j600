...
/* SRAM memory layout:
 *
 * 0x0000-0x0bff TX buffers  3.0KB  (2*1536) reside in the GP area in SRAM
 * 0x0c00-0x5fff RX buffers 22.5KB (15*1536) reside in the RX area in SRAM
 */
#define TX_BUF_SIZE  0x0600U
